...
function ContactUs() {
  return (
    <div className='flex justify-center items-center w-full h-lvh bg-[#FAFAFA]'>
      ...
      <div className='flex flex-col justify-evenly items-centerS bg-white h-[550px] w-[550px] border-[10855845s] border-[10px]'>
      
      <div className='flex flex-col justify-evenly w-full h-full items-center px-5 py-5'>

      <div className='flex flex-col justify-center items-center gap-3'>
        <h1 className='text-3xl text-black font-semibold border-[5px] px-2 py-2 border-[10855845s]'>CONTACT US</h1>
