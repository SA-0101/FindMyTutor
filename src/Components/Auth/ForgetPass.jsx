  ...
  function handleSubmit(e) {
    ...
    return (
        <div className='flex flex-col justify-between gap-4 py-5 items-center overflow-y-hidden  max-w-full min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50'>
            ...
            <div className='flex flex-col w-[33%] h-auto justify-between rounded-lg px-6 py-2 bg-white items-center shadow-lg shadow-gray-200'>
              ...
              <div className='w-full flex justify-between items-center px-2 rounded-lg border border-gray-300 bg-gray-100'>
                    <Mail className="h-5 w-5 text-gray-400" />
                    <input type="email" placeholder=' Enter email address' className='w-full outline-0 px-3 py-1 md:py-3' onChange={(e)=>{setEmail(e.target.value)}}/>
              </div>

                <button type='submit' className='bg-orange-500 w-full py-1 md:py-3 text-white font-semibold rounded-lg cursor-pointer hover:scale-[102%] hover:bg-orange-600'>Send Code</button>
              </form>
