    ...
    return (
        <div className='flex flex-col justify-between gap-4 py-5 items-center overflow-y-hidden  max-w-full min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50'>
            ...
            <div className='flex flex-col w-[33%] h-auto justify-between rounded-lg px-6 py-3 bg-white items-center shadow-lg shadow-gray-200'>
             <div className='flex justify-center items-center w-16 h-16 rounded-[100%] bg-purple-300'><Lock className="w-7 h-7" /></div>
              <h1 className='text-2xl font-bold py-3'>Reset Password</h1>
              ...
              <div className='w-full flex justify-between items-center px-2 rounded-lg border border-gray-300 bg-gray-100'>
                    ...
                    <input autoComplete='on' type="password" placeholder='Enter your new password' className='w-full outline-0 px-3 py-3' onChange={(e)=>{setNewpass(e.target.value)}}/>
              </div>
                
               <div className='w-full flex justify-between items-center px-2 rounded-lg border border-gray-300 bg-gray-100'>
                     <Lock className="h-5 w-5 text-gray-400" />
                    <input autoComplete='on' type="text" placeholder='Confirm your new password' className='w-full outline-0 px-3 py-3' onChange={(e)=>{setConfirmpass(e.target.value)}}/>
              </div>

                <button type='submit' className='bg-purple-500 w-full py-3 text-white font-semibold rounded-lg cursor-pointer hover:scale-[102%] hover:bg-blue-700'>Reset Password</button>
              </form>
